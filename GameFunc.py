        ...
        if len(self.agent_dict.keys()) == 1:
            if self.agent_dict.get(self.agent2pokemon()[0]).dest == -1:
                if len(self.agent2pokemon()[1]) > 1:
                    cli.choose_next_edge(
                        '{"agent_id":%s, "next_node_id":%s}' % (self.agent2pokemon()[0], self.agent2pokemon()[1][1]))
                else:
                    cli.choose_next_edge(
                        '{"agent_id":%s, "next_node_id":%s}' % (self.agent2pokemon()[0], self.agent2pokemon()[1][0]))
